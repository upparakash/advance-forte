      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12">
            {/* Test Pattern */}
            <div className="bg-white/70 backdrop-blur-sm border border-white/20 rounded-2xl p-4 sm:p-6 shadow-lg">
              <div className="bg-gradient-to-br from-blue-500 to-blue-600 w-12 h-12 sm:w-16 sm:h-16 rounded-2xl flex items-center justify-center mb-4">
                <FileText className="text-white" size={20} />
              </div>
              <h3 className="text-lg sm:text-xl font-bold mb-3 text-gray-800">Test Pattern</h3>
            ...
            <div className="bg-white/70 backdrop-blur-sm border border-white/20 rounded-2xl p-4 sm:p-6 shadow-lg">
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-3 text-gray-800">Eligibility</h3>
              <ul className="space-y-2 text-sm sm:text-base text-gray-700">
            ...
            <div className="bg-white/70 backdrop-blur-sm border border-white/20 rounded-2xl p-4 sm:p-6 shadow-lg">
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-3 text-gray-800">Scholarship Slabs</h3>
              <ul className="space-y-2 text-sm sm:text-base text-gray-700">
                <li>• 90% - 1st Rank</li>
                <li>• 75% - 2nd Rank</li>
                <li>• 50% - 3rd Rank</li>
          ...
          {/* Important Dates */}
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 sm:p-8 mb-8 sm:mb-12">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              <div className="text-center">
                <div className="bg-white rounded-xl p-3 sm:p-4 shadow-md">
                  <div className="text-lg sm:text-2xl font-bold text-primary-600 mb-1">10 Jan</div>
                  <div className="text-xs sm:text-sm text-gray-600">Registration Opens</div>
                </div>
              </div>
              <div className="text-center">
                <div className="bg-white rounded-xl p-3 sm:p-4 shadow-md">
                  <div className="text-lg sm:text-2xl font-bold text-primary-600 mb-1">5 Mar</div>
                  <div className="text-xs sm:text-sm text-gray-600">Registration Closes</div>
                </div>
              </div>
              <div className="text-center">
                <div className="bg-white rounded-xl p-3 sm:p-4 shadow-md">
                  <div className="text-lg sm:text-2xl font-bold text-primary-600 mb-1">11 Mar</div>
                  <div className="text-xs sm:text-sm text-gray-600">Scholarship Test</div>
                </div>
              </div>
              <div className="text-center">
                <div className="bg-white rounded-xl p-3 sm:p-4 shadow-md">
                  <div className="text-lg sm:text-2xl font-bold text-primary-600 mb-1">15 Mar</div>
                  <div className="text-xs sm:text-sm text-gray-600">Results Declared</div>
                </div>
              </div>
            </div>
          </div>
