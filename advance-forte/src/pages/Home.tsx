...
const Home: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50">
      {/* Hero Section */}
      <section className="relative flex flex-col items-center justify-center min-h-[90vh] sm:min-h-[80vh] text-center overflow-hidden px-4">
        {/* Animated Background */}
        <div className="absolute inset-0 bg-gradient-to-br from-primary-600 via-primary-700 to-secondary-600">
          {/* Floating Elements - Hidden on mobile for better performance */}
          <div className="hidden sm:block absolute top-20 left-20 w-20 h-20 bg-warning-400/30 rounded-full animate-float"></div>
          <div className="hidden sm:block absolute top-32 right-32 w-16 h-16 bg-accent-400/30 rounded-full animate-bounce-gentle"></div>
          <div className="hidden sm:block absolute bottom-40 left-1/4 w-24 h-24 bg-success-400/30 rounded-full animate-pulse-soft"></div>
          <div className="hidden sm:block absolute bottom-20 right-20 w-18 h-18 bg-primary-300/30 rounded-full animate-float"></div>
        ...
        <div className="relative z-20 w-full max-w-5xl mx-auto">
          {/* Main Heading */}
          <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold font-educational text-white mb-4 sm:mb-6 animate-slide-up">
            Advance Forte
          </h1>
          ...
          <div className="mb-6 sm:mb-8 animate-fade-in">
            <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4 mb-4 sm:mb-6">
              <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-3 py-2 sm:px-4 border border-white/30">
                <Target className="text-yellow-300" size={16} />
                <span className="text-white font-semibold text-sm sm:text-base">IIT-JEE</span>
              </div>
              <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-3 py-2 sm:px-4 border border-white/30">
                <GraduationCap className="text-green-300" size={16} />
                <span className="text-white font-semibold text-sm sm:text-base">NEET</span>
              </div>
              <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-3 py-2 sm:px-4 border border-white/30">
                <BookOpen className="text-blue-300" size={16} />
                <span className="text-white font-semibold text-sm sm:text-base">Foundation</span>
              </div>
            </div>
            <p className="text-base sm:text-lg md:text-xl text-primary-200 max-w-2xl mx-auto leading-relaxed mb-2 px-4">
              Premier coaching for IIT-JEE, NEET, and Foundation.
            </p>
            <p className="text-lg sm:text-xl md:text-2xl font-semibold text-yellow-300 max-w-2xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-6 sm:mb-8 px-4">
            <Link
              to="/scholarship"
              className="group inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-primary-500 to-primary-600 text-white font-bold rounded-full shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 animate-scale-in text-sm sm:text-base"
            >
              <Trophy className="mr-2 group-hover:animate-bounce text-white" size={18} />
              Scholarship
              <ArrowRight size={18} className="ml-2 group-hover:translate-x-1 transition-transform text-white" />
            </Link>
            <a
              href="https://wa.me/918853123199?text=Hello%2C%20I%20would%20like%20to%20know%20more%20about%20your%20courses"
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-white/20 backdrop-blur-sm border-2 border-white/30 text-white font-bold rounded-full shadow-xl hover:bg-white/30 hover:scale-105 transition-all duration-300 animate-scale-in text-sm sm:text-base"
            >
              <Users className="mr-2 group-hover:animate-pulse text-white" size={18} />
          ...
          {/* Quick Stats */}
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-6 text-white/90 animate-fade-in px-4">
            <div className="flex items-center justify-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-3 sm:px-4 py-2">
              <Users className="text-yellow-300" size={16} />
              <span className="font-semibold text-xs sm:text-sm">10,000+ Happy Students</span>
            </div>
            <div className="flex items-center justify-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-3 sm:px-4 py-2">
              <Trophy className="text-green-300" size={16} />
              <span className="font-semibold text-xs sm:text-sm">98% Success Rate</span>
            </div>
            <div className="flex items-center justify-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-3 sm:px-4 py-2">
              <Star className="text-blue-300" size={16} />
              <span className="font-semibold text-xs sm:text-sm">Expert Faculty</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-white/70 backdrop-blur-sm border border-white/20 rounded-2xl p-8 shadow-xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="https://maps.app.goo.gl/HHK4PVdxEdXxDHfz7"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-primary-500 to-primary-600 text-white font-bold rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
                >
