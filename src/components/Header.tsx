        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              <img src={logo} alt="Advance Forte Logo" className={`h-14 w-auto mr-3 ${isScrolled ? '' : 'drop-shadow-lg'}`} />
              <span className={`text-2xl font-bold font-educational ${isScrolled ? 'text-blue-700' : 'text-blue-400'}`}>Advance Forte</span>
              <span className={`ml-1 text-lg font-medium font-educational ${isScrolled ? 'text-green-600' : 'text-green-300'}`}>IIT-JEE | NEET | FOUNDATION</span>
            </Link>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link 
              to="/" 
              className={`font-medium font-educational transition-colors duration-200 hover:text-blue-600 relative px-2 py-1
                ${isScrolled ? 'text-gray-800' : 'text-gray-400'}
                ${isActive('/') ? (isScrolled ? 'text-blue-600 after:content-[" "] after:absolute after:left-0 after:right-0 after:bottom-0 after:h-0.5 after:bg-gradient-to-r after:from-blue-600 after:to-green-600 after:rounded-full after:opacity-80' : 'text-blue-300 underline underline-offset-4') : ''}`}
            >
              Home
            </Link>
            ...
            <div className="relative" ref={coursesDropdownRef}>
              <button
                ...
                className={`flex items-center font-medium font-educational transition-colors duration-200 hover:text-blue-600 relative px-2 py-1
                  ${isScrolled ? 'text-gray-800' : 'text-gray-400'}
                  ${isActive('/courses') ? (isScrolled ? 'text-blue-600 after:content-[" "] after:absolute after:left-0 after:right-0 after:bottom-0 after:h-0.5 after:bg-gradient-to-r after:from-blue-600 after:to-green-600 after:rounded-full after:opacity-80' : 'text-blue-300 underline underline-offset-4') : ''}`}
              >
                Courses
            ...
            <div className="relative" ref={examsDropdownRef}>
              <button
                ...
                className={`flex items-center font-medium font-educational transition-colors duration-200 hover:text-blue-600 relative px-2 py-1
                  ${isScrolled ? 'text-gray-800' : 'text-gray-400'}
                  ${isActive('/exams') ? (isScrolled ? 'text-blue-600 after:content-[" "] after:absolute after:left-0 after:right-0 after:bottom-0 after:h-0.5 after:bg-gradient-to-r after:from-blue-600 after:to-green-600 after:rounded-full after:opacity-80' : 'text-blue-300 underline underline-offset-4') : ''}`}
              >
                Exams
                <ChevronDown size={16} className="ml-1" />
              </button>
            ...
            <Link 
              ...
              className={`font-medium font-educational transition-colors duration-200 hover:text-blue-600 relative px-2 py-1
                ${isScrolled ? 'text-gray-800' : 'text-gray-400'}
                ${isActive('/faculty') ? (isScrolled ? 'text-blue-600 after:content-[" "] after:absolute after:left-0 after:right-0 after:bottom-0 after:h-0.5 after:bg-gradient-to-r after:from-blue-600 after:to-green-600 after:rounded-full after:opacity-80' : 'text-blue-300 underline underline-offset-4') : ''}`}
            >
              Faculty
            </Link>
            ...
            <Link 
              ...
              className={`font-medium font-educational transition-colors duration-200 hover:text-blue-600 relative px-2 py-1
                ${isScrolled ? 'text-gray-800' : 'text-gray-400'}
                ${isActive('/blogs') ? (isScrolled ? 'text-blue-600 after:content-[" "] after:absolute after:left-0 after:right-0 after:bottom-0 after:h-0.5 after:bg-gradient-to-r after:from-blue-600 after:to-green-600 after:rounded-full after:opacity-80' : 'text-blue-300 underline underline-offset-4') : ''}`}
            >
              Blogs
            </Link>
